 ...
 * Generated at: 2024-04-29 00:15:20 UTC
...
public final class courseView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/Pages/../DBconnection.jsp", Long.valueOf(1714347905009L));
    _jspx_dependants.put("/Pages/../userAuth.jsp", Long.valueOf(1714347906611L));
  }
...
try{
    ...
    username = "username";
      ...
      out.write("                <input type=\"hidden\" name=\"action\" value=\"comment\">\n");
      out.write("                <input type=\"text\" name=\"comment\" placeholder=\"Add a comment...\" style=\"width: 50%; padding: 10px; outline: none; border: 1px solid black; border-radius: 10px; font-size: 1em; margin-left: 10%;\" required>\n");
      out.write("                <input type=\"hidden\" name=\"courseId\" value=\"");
      out.print( courseId );
      out.write("\">\n");
      out.write("                <button type=\"submit\" class=\"buttonAccent\" style=\"font-size: 0.7em; margin: 0; padding: 5px 10px; margin-top: 0.5em; margin-bottom: 2em; margin-left: 10%;\">Post Comment</button>\n");
      out.write("            </form>\n");
      out.write("\n");
      out.write("            ");
